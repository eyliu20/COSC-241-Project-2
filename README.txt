...
if lose: -500
if win: +500
+= -2/total unscared ghost distance (manhattan) 
+= 100/total scared ghost distance
...
We made it so pacman would chase the scared ghosts by checking if the scared timer is greater than 0
